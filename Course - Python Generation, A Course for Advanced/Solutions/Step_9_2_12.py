# Текст задания: https://stepik.org/lesson/445985/step/12?unit=470426
...
# блоков строк, описывающих листки с фамилиями. На первой строке каждого блока указано количество фамилий ni, затем идёт
# ni строчек с фамилиями тех, кто был на уроке i-ом уроке.
#
...
lessons = [set(input() for _ in range(int(input()))) for lesson in range(int(input()))]
print(*sorted(set.intersection(*lessons)), sep='\n')
